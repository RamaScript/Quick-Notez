...
class NotesDb {
  ...
  Future<sqflite.Database> get database async {
    ...
    _database = await _initDB('quick_notez.db');
    return _database!;
  }
  ...
  Future<int> addNote(String title, String description, String date,
      int color) async {
  ...
  Future<int> updateNotes(String title, String description, String date,
      int color, int? id) async {
    final db = await instance.database;
